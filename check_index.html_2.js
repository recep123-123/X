...
(function(){
  ...
  // Build labels
  try{document.querySelectorAll('h2').forEach(h=>{if(h.textContent.includes('OMNINOMICS PREMIUM TRADE COCKPIT'))h.textContent='OMNINOMICS PREMIUM TRADE COCKPIT v5.1.7';});}catch{}
  patchPages();
